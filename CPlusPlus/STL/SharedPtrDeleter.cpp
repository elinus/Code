...
template <typename T> int Deleter<T>::count = 0;
...
int main() {
  ...
  {
    std::unique_ptr<double, DoubleDeleter> uniquePtr(new double,
                                                     DoubleDeleter());
    std::unique_ptr<double, DoubleDeleter> uniquePtr1(new double,
                                                      DoubleDeleter());
