...
template<typename TContainer>
void printMap(TContainer begin, TContainer end) {
    for (TContainer it = begin; it != end; ++it) {
...
int main (int argc, char *argv[])
{
    ...
    cout << "myset min value is: " << *min_element(myset.begin(), myset.end()) << endl;
    cout << "mymap min value is: " 
        << min_element(mymap.begin(), mymap.end())->first 
        << " "
        << min_element(mymap.begin(), mymap.end())->second 
        << endl;
    cout << "mydeque min value is: " << *min_element(mydeque.begin(), mydeque.end()) << endl;

    cout << endl << endl;

    // Max values
    cout << "myvector min value is: " << *max_element(myvector.begin(), myvector.end()) << endl;
    cout << "mylist min value is: " << *max_element(mylist.begin(), mylist.end()) << endl;
    cout << "myset min value is: " << *max_element(myset.begin(), myset.end()) << endl;
    cout << "mymap min value is: " 
        << max_element(mymap.begin(), mymap.end())->first 
        << " "
        << max_element(mymap.begin(), mymap.end())->second 
        << endl;
    cout << "mydeque min value is: " << *max_element(mydeque.begin(), mydeque.end()) << endl;
