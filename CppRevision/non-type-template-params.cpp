...
public:
  ...
  void printnonType() {
    cout << "myclass.otpint is " << myc.otpint << " t is " << t << " d is " << d
         << " f is " << f << endl;
  }
...
// Template class demo with user defined object and int parameter with default
// value.
template <class myclass, int myint = 0> class nonTypedefault {
