...
public class DequeProducer {
    private final Random random = new Random();
    private BlockingDeque deque;
    private String name1;
    private String name2;

    public DequeProducer(BlockingDeque deque, String name1, String name2) {
        this.deque = deque;
        this.name1 = name1;
        this.name2 = name2;
    }
        ...
        public void run() {
            for (int i = 0; i < 10; i++) {
                try {
                    ...
                    System.out.printf("[%s] - PutFirst object = %s%n", Thread.currentThread().getName(), value);
                    printDeque();
