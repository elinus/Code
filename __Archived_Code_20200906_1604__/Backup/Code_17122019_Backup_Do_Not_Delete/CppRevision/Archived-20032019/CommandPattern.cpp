...
public:
  ...
  void turnOn() { cout << "Television - ON" << endl; }
  void turnOff() { cout << "Television - OFF" << endl; }
  void volumeUp() { cout << "Television volume up:  " << ++volume << endl; }
  void volumeDown() { cout << "Television volume down: " << --volume << endl; }
  void channelUp() { cout << "Television channel up: " << ++channel << endl; }
  void channelDown() {
...
public:
  TVRemote(Command &tvOnCommand, Command &tvOffCommand,
      ...
      : tvOnCommand(tvOnCommand), tvOffCommand(tvOffCommand),
        ...
        channelUpCommand(channelUpCommand),
        channelDownCommand(channelDownCommand) {}
